...
class TestTaskService:
    ...
    async def test_get_user_id_success(
        self, task_service: TaskService, test_user: User
    ):
    ...
    async def test_create_task_success(self, task_service: TaskService):
        ...
        task_data = TaskRequest(
            title="Test Task", description="Test Description", status=TaskStatus.PENDING
        )
    ...
    @pytest.mark.asyncio
    async def test_get_user_task_by_id_wrong_user(
    ...
    async def test_delete_task_success(self, task_service: TaskService):
        created_task = await task_service.create_task(
            TaskRequest(title="Task to delete")
        )
