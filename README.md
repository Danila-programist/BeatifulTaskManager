...
1. Токены искусствено живет 15 минут
...
4. В минимальной реализации и запуске проекта необходимо только `docker` и `docker-compose` (без тестирования и ручной отладки модулей)
5. Ручки бэкенда открыты на 8000 порту через nginx